        ...
        <div className="auto-fit-grid gap-px border border-line-strong bg-line-strong text-center [--auto-fit-min:7rem]">
          {columns.map((column) => (
            <div
              ...
              key={column}
            >
              <div className="blueprint-title whitespace-nowrap border-b border-line-strong px-1.5 py-2 text-[0.68rem] leading-none text-text-primary sm:py-3 sm:text-sm">
                {column}
              </div>
  ...
  return (
    <div className="min-h-screen px-3 py-3 sm:px-6 sm:py-6 lg:px-8">
      <div className="blueprint-surface blueprint-surface-strong blueprint-grid-paper mx-auto flex min-h-[calc(100svh-1.5rem)] max-w-[96rem] flex-col overflow-hidden sm:min-h-[calc(100vh-3rem)]">
        <div className="auto-fit-grid min-w-0 flex-1 items-center gap-8 px-4 py-7 [--auto-fit-min:28rem] sm:px-6 sm:py-10 lg:px-14 lg:py-12">
          <section className="fade-up min-w-0 space-y-8">
            <div className="space-y-6">
              <div>
                <h1 className="blueprint-title text-5xl leading-[0.86] text-text-primary sm:text-7xl lg:text-8xl">
                  Workflow
                </h1>
                <h1 className="blueprint-title text-5xl leading-[0.86] text-text-primary sm:text-7xl lg:text-8xl">
                  Blueprint
              ...
              <div className="h-1 w-40 max-w-full rounded-full bg-brand sm:w-56" />
              <p className="text-2xl font-medium text-text-primary sm:text-3xl">
            ...
            <div className="auto-fit-grid gap-4 pt-8 [--auto-fit-min:12rem]">
              {[
                ...
                <div className="flex items-center gap-3" key={item.title}>
                  <div className="flex h-12 w-12 items-center justify-center rounded-lg border border-line-strong bg-surface-control">
            ...
            <BlueprintCard className="mx-auto w-full max-w-2xl p-5 sm:p-10">
              <div className="space-y-8">
                <div className="space-y-2 text-center">
                  <h2 className="blueprint-title text-4xl text-text-primary sm:text-5xl">
                    Welcome Back
                  </h2>
        ...
        <footer className="border-t border-line-soft px-6 py-4 text-center text-sm font-semibold text-text-muted lg:px-14">
          Built by{" "}
          <a
            className="text-brand underline decoration-2 underline-offset-4"
